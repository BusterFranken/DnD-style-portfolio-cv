...
async function generateFullSheet(cvText, onProgress) {
  const client = new OpenAI({
    // .trim() defends against a trailing newline / stray whitespace in the
    // pasted key — a newline in the Authorization header otherwise fails the
    // request at the transport layer ("Connection error.").
